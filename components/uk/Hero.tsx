    ...
    <section className="py-14 md:py-20 overflow-hidden bg-white relative">
      ...
      <div className="md:hidden px-5 relative z-10">
        ...
        <div
          ...
          style={{ background: "#0f1520 url('https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=900&q=80') center/cover" }}
        />
            ...
            <div className={`relative h-[520px] ${base} duration-800 delay-200 ${mounted ? show : hideRight}`}>
              <div
                ...
                style={{
                  ...
                  background: "#0f1520 url('https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=900&q=80') center/cover",
              ...
              >
                ...
                />
                <span className="text-[13px] font-semibold text-black whitespace-nowrap">Innovator Visa Active</span>
              </div>
              <div
              ...
              >
                ...
                <span className="font-bold text-[13px] text-black">ILR at Year 3</span>
              </div>
            </div>
          </div>
        </Row>
