        ...
        <div className="w-full">
            ...
            <div className="flex flex-col items-center gap-10 py-10 px-6 md:hidden">
                ...
                <div className="w-full flex flex-col justify-between text-left">
                    <h2 className="my-8 text-2xl font-medium text-black">
                    ...
                    <Link
                        href="#"
                        className="mt-7 h-12 w-45 border border-[#8F27FF] text-[#8F27FF] hover:bg-[#8F27FF] hover:text-white flex items-start justify-start rounded-3xl px-6 py-3 text-base transition-colors duration-300"
                    >
                        Meet Our Team →
                    </Link>
                </div>
                ...
                <Row>
                    <div className="flex flex-row items-center gap-18">
                        ...
                        <div className="w-1/2 flex flex-col justify-between text-left">
                            <h2 className="my-8 text-[32px] font-medium text-black">
                                Behind the <mark className='bg-[#FFE600]'>Nexa</mark>
                            </h2>
                            ...
                            <Link
                                href="#"
                                className="mt-7 h-12 w-max border border-[#8F27FF] text-[#8F27FF] hover:bg-[#8F27FF] hover:text-white flex items-center justify-center rounded-3xl px-6 py-3 text-base transition-colors duration-300"
                            >
                                Meet Our Team →
                            </Link>
                        </div>
