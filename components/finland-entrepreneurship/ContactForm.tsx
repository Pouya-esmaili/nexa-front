      ...
      <Row>
        <Reveal variant="up">
          <h2 className="text-[28px] md:text-[40px] font-bold tracking-[-0.03em] text-center mb-10 md:mb-14">
            Start Your Finland Entrepreneur Visa Journey
          </h2>
        </Reveal>
          ...
          <Reveal variant="up" delay={100}>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  <span className="text-[#474747]">Business Structure</span>
                  <select className="h-11 px-3.5 rounded-[10px] border border-[#E2E2E2] bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
                    <option>Sole Proprietor (Toiminimi)</option>
                    <option>General Partnership (Avoin yhtiö)</option>
                    <option>Limited Partnership (Ky)</option>
                    <option>Limited Company (Oy)</option>
                ...
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  ...
                  <select className="h-11 px-3.5 rounded-[10px] border border-[#E2E2E2] bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
                    ...
                    <option>Trade / Import-Export</option>
                    <option>Other</option>
                  </select>
                </label>
              </div>
              ...
              {/* Textarea */}
              <label className="flex flex-col gap-2 text-[13px] font-medium">
                <span className="text-[#474747]">Tell us about your business &amp; goals</span>
                <textarea
                  rows={4}
                  placeholder="Describe your business model, client pipeline, and what you're looking to achieve in Finland…"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
                <small className="text-[12px] text-[#929292] leading-relaxed max-w-[50ch]">
                  Your information is reviewed confidentially by Nexa&apos;s advisory team. We typically respond within
                  48 hours.
                </small>
                <button
                  type="submit"
