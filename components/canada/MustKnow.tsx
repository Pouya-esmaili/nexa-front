          ...
          {cards.map((c, i) => (
            <Reveal key={c.num} variant="up" delay={i * 80 + 100}>
              ...
              >
                ...
                <h3 className="text-[22px] font-semibold leading-[1.3] tracking-[-0.02em] text-white mb-3 relative z-10">{c.title}</h3>
                <p className="text-[14.5px] leading-[1.65] relative z-10" style={{ color: "rgba(255,255,255,0.7)" }}>{c.body}</p>
              </div>
            </Reveal>
          ))}
        </div>
