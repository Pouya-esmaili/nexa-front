...
const cards = [
  { title: "Solo Founder", sub: "100% IPREM monthly / 1,200% annually", amount: "~€9,000" },
  { title: "Founder + Spouse", sub: "+50% IPREM for the first dependent", amount: "~€13,500" },
  { title: "Each Additional Dependent", sub: "+25% IPREM per additional child", amount: "+~€2,250" },
];
          ...
          <Reveal variant="left" delay={100}>
            <div className="rounded-[20px] p-10 flex flex-col gap-5 h-full" style={{ background: "#0E0E10", border: "1px solid #1f1f24" }}>
              <div className="self-start text-[11px] font-bold tracking-[0.12em] uppercase px-3.5 py-1.5 rounded-full"
                ...
                IPREM-Based Threshold
              </div>
              <div className="text-[72px] font-bold tracking-[-0.04em] leading-[0.9] text-white">~€9K</div>
              <p className="text-[14px] leading-[1.65]" style={{ color: "#B5B5BA" }}>
                Minimum personal liquid funds for a <strong style={{ color: "#FFE600", fontWeight: 600 }}>solo founder</strong> — equivalent to 1,200% of Spain&apos;s IPREM annual index.
              </p>
              <div className="flex flex-wrap gap-2 mt-auto pt-4" style={{ borderTop: "1px solid #1f1f24" }}>
                {["Certified bank statements", "Investment allocations", "VC funding term sheets", "Fixed-term deposits"].map((chip) => (
