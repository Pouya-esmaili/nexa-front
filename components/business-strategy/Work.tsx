...
const WORKS = [
  {
    ...
    title: "New Market Growth Plan", titleFa: "برنامه توسعه در بازار جدید",
  ...
  },
  {
    ...
    title: "Venture Pitch Narrative", titleFa: "روایت یک کسب‌وکار برای جذب سرمایه",
  ...
  {
    img: "004-category-opportunity.jpg",
    extraClass: "wc3",
    status: "CASE STUDY", statusFa: "بررسی یک پروژه",
    small: "MARKET ANALYSIS / BRAND", smallFa: "تحلیل بازار / برند",
    title: "Category Opportunity Study", titleFa: "مطالعه فرصت‌های یک بازار",
