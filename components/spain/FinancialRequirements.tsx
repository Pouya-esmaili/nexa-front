...
const cards = [
  { title: "Solo Founder", titleFa: "کارآفرین اصلی", sub: "100% IPREM monthly / 1,200% annually", subFa: "۱۰۰٪ IPREM ماهانه / ۱۲۰۰٪ سالانه", amount: "~€9,000", amountFa: "حدود ۹٬۰۰۰ یورو" },
  { title: "Founder + Spouse", titleFa: "کارآفرین + همسر", sub: "+50% IPREM for the first dependent", subFa: "۵۰٪ IPREM اضافه برای اولین فرد تحت تکفل", amount: "~€13,500", amountFa: "حدود ۱۳٬۵۰۰ یورو" },
  { title: "Each Additional Dependent", titleFa: "هر فرد تحت تکفل اضافی", sub: "+25% IPREM per additional child", subFa: "۲۵٪ IPREM اضافه برای هر فرزند", amount: "+~€2,250", amountFa: "حدود ۲٬۲۵۰ یورو" },
];
          ...
          <Reveal variant="left" delay={100}>
            <div className="rounded-[20px] p-10 flex flex-col gap-5 h-full" style={{ background: "#0E0E10", border: "1px solid #1f1f24" }}>
              <div className="self-start text-[11px] font-bold tracking-[0.12em] uppercase px-3.5 py-1.5 rounded-full"
                ...
                {t("IPREM-Based Threshold", "حداقل منابع مالی بر مبنای IPREM")}
              </div>
              <div className="text-[72px] font-bold tracking-[-0.04em] leading-[0.9] text-white">{t("~€9K", "حدود ۹ هزار یورو")}</div>
              <p className="text-[14px] leading-[1.65]" style={{ color: "#B5B5BA" }}>
                {t("Minimum personal liquid funds for a", "حداقل منابع مالی شخصی و نقدشونده برای")} <strong style={{ color: "#FFE600", fontWeight: 600 }}>{t("solo founder", "کارآفرین اصلی")}</strong> {t("— equivalent to 1,200% of Spain's IPREM annual index.", "؛ معادل ۱۲۰۰٪ شاخص سالانه IPREM اسپانیا.")}
              </p>
              <div className="flex flex-wrap gap-2 mt-auto pt-4" style={{ borderTop: "1px solid #1f1f24" }}>
                {[
                  { en: "Certified bank statements", fa: "گواهی و گردش حساب بانکی" },
                  { en: "Investment allocations", fa: "مدارک تخصیص سرمایه" },
                  { en: "VC funding term sheets", fa: "Term Sheetهای تأمین مالی از VCها" },
                  { en: "Fixed-term deposits", fa: "سپرده‌های بانکی مدت‌دار" },
                ].map((chip) => (
