...
const items = [
  {
    ...
    titleFa: "صاحبان کسب‌وکار با تجربه که به دنبال توسعه بین‌المللی هستند,",
  ...
  },
  {
    ...
    titleFa: "سرمایه‌گذارانی که به دنبال فرصت‌های ارزشمند و پربازده هستند,",
  ...
  },
  {
    ...
    titleFa: "کارآفرینان و متخصصانی که قصد انتقال یا گسترش کسب‌وکار خود به خارج از کشور را دارند,",
  ...
  },
  {
    ...
    titleFa: "صاحبان کسب‌وکاری که می‌خواهند فعالیت خود را فراتر از بازار داخلی توسعه دهند, ",
  ...
  },
  {
    ...
    titleFa: "بنیان‌گذاران استارتاپ‌های نوپا که به دنبال ایجاد پایگاهی برای رشد جهانی هستند,",
  ...
  },
  {
    ...
    titleFa: "خانواده‌هایی که از طریق کارآفرینی به دنبال آینده‌ای پایدار و دریافت اقامت هستند,",
      ...
      <Row>
        <Reveal variant="up">
          <h2 className="text-[28px] md:text-[40px] font-bold tracking-[-0.03em] leading-[1.1] text-center mb-14">
            {t("Who Is This Program Designed For?", "این برنامه مناسب چه افرادی است؟")}
          </h2>
        </Reveal>
