...
const projects = [
  ...
  { name: "Landa Craft",     tag: "Handcraft · Artisan Market",       tagFa: "صنایع‌دستی · بازار هنر",         img: "/images/about/craft.jpg", icon: "/images/landing/craft.svg" },
  { name: "AutiLab",         tag: "Autism Support · Child EdTech",    tagFa: "حمایت از اوتیسم · فناوری آموزش کودک", img: "/images/about/autiLab.jpg", icon: "/images/landing/Autilab.svg" },
  { name: "Vision Raft",     tag: "Virtual Reality · Immersive Tech", tagFa: "واقعیت مجازی · فناوری فراگیر",   img: "/images/about/vision.jpg", icon: "/images/landing/raft.svg" },
  { name: "Diaco",           tag: "Business Solutions · Corporate",   tagFa: "راهکارهای کسب‌وکار · سازمانی",   img: "/images/about/Diaco.jpg", icon: "/images/startup/Diaco.svg" },
  ...
  { name: "SteadySkull",     tag: "Surgical Device · MedTech",        tagFa: "تجهیزات جراحی · فناوری پزشکی",   img: "/images/about/steadyskull.jpg",   icon: "/images/landing/SteadySkull.svg" },
];
