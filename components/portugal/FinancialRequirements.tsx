...
const cards = [
  { title: "Main Applicant (100% Minimum Wage)", titleFa: "متقاضی اصلی — ۱۰۰٪ حداقل دستمزد", sub: "Personal liquid funds baseline", subFa: "حداقل منابع مالی شخصی و نقدشونده", amount: "~€10,000", amountFa: "حدود ۱۰٬۰۰۰ یورو" },
  { title: "Spouse / Adult Dependent (+50%)", titleFa: "همسر / فرد بزرگسال تحت تکفل — ۵۰٪ اضافه", sub: "Additional per adult family member", subFa: "منابع مالی اضافی برای هر عضو بزرگسال خانواده", amount: "+~€5,000", amountFa: "حدود ۵٬۰۰۰ یورو" },
  { title: "Each Dependent Child (+30%)", titleFa: "هر فرزند تحت تکفل — ۳۰٪ اضافه", sub: "Additional per minor child", subFa: "منابع مالی اضافی برای هر فرزند زیر سن قانونی", amount: "+~€3,000", amountFa: "۳۰٪ از حداقل دستمزد ملی" },
];
          ...
          <Reveal variant="left" delay={100}>
            <div className="rounded-[20px] p-10 flex flex-col gap-5 h-full" style={{ background: "#0E0E10", border: "1px solid #1f1f24" }}>
              <div className="self-start text-[11px] font-bold tracking-[0.12em] uppercase px-3.5 py-1.5 rounded-full"
                ...
                {t("Salário Mínimo Nacional Baseline", "حداقل منابع مالی بر مبنای حداقل دستمزد ملی پرتغال")}
              </div>
              <div className="text-[72px] font-bold tracking-[-0.04em] leading-[0.9] text-white">{t("~€10K", "حدود ۱۰ هزار یورو")}</div>
              <p className="text-[14px] leading-[1.65]" style={{ color: "#B5B5BA" }}>
                {t("Annual personal maintenance threshold for a", "حداقل منابع مالی شخصی موردنیاز برای تأمین هزینه‌های سالانه")} <strong style={{ color: "#FFE600", fontWeight: 600 }}>{t("solo founder", "کارآفرین اصلی")}</strong> {t("— pegged to Portugal's national minimum wage.", "، بر مبنای حداقل دستمزد ملی پرتغال.")}
              </p>
              <div className="flex flex-wrap gap-2 mt-auto pt-4" style={{ borderTop: "1px solid #1f1f24" }}>
                {[
                  { en: "Portuguese bank account", fa: "حساب بانکی در پرتغال" },
                  { en: "Share capital deposits", fa: "سپرده سرمایه شرکت" },
                  { en: "Dividend contracts", fa: "قراردادهای دریافت سود سهام" },
                  { en: "Executive salary records", fa: "مدارک مربوط به حقوق و دستمزد مدیریتی" },
                ].map((chip) => (
