...
const breakdown = [
  { num: "100", label: "Leg 1", min: "min 30" },
  { num: "100", label: "Leg 2", min: "min 30" },
  { num: "100", label: "Leg 3", min: "min 30" },
];
          ...
          >
            ...
            >
              ...
              <p className="text-[14px] text-[#929292] leading-[1.65]">
                The RVO doesn&apos;t grade on a curve. Three legs, three minimums — all must be
                cleared. Nexa engineers your application package to maximize points across every
