      ...
      <Row>
        <Reveal variant="up">
          <h2 className="text-[28px] md:text-[40px] font-bold tracking-[-0.03em] text-center mb-10 md:mb-14">
            Start Your Netherlands Self-Employed Visa Journey
          </h2>
        </Reveal>
          ...
          <Reveal variant="up" delay={100}>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  ...
                  <select className="h-11 px-3.5 rounded-[10px] border border-[#E2E2E2] bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
                    <option>Tech / SaaS / Software</option>
                ...
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  <span className="text-[#474747]">Estimated RVO Score</span>
                  <select className="h-11 px-3.5 rounded-[10px] border border-[#E2E2E2] bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
                    <option>Not yet assessed</option>
                    <option>Below 90 — Need guidance</option>
                    <option>90–150 — Borderline</option>
                    <option>150+ — Strong profile</option>
                  </select>
                </label>
              </div>
              ...
              <label className="flex flex-col gap-2 text-[13px] font-medium">
                ...
                <textarea
                  rows={4}
                  placeholder="Describe your business model, client pipeline, Dutch market plans, and what you're looking to achieve…"
