            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_380px]">
              ...
              <div className="bg-black px-12 py-[52px] flex flex-col gap-5 relative overflow-hidden">
                ...
                <div className="inline-flex items-center gap-2 self-start text-[11px] font-bold uppercase tracking-[0.1em] text-black bg-[#FF4444] px-[14px] py-1.5 rounded-full">
                  ...
                  {t("Program Pause in Effect", "وضعیت فعلی برنامه")}
                </div>

                <h2 className="text-[26px] md:text-[34px] font-bold text-white tracking-[-0.03em] leading-[1.1] relative z-10">
                  {t("The window was open.", "مهلت به پایان رسید؛")}<br />
                  <em className="text-[#FFE600] not-italic">{t("But only until June 30.", "۳۰ ژوئن ۲۰۲۶")}</em>
                </h2>

                <p className="text-[14.5px] text-[rgba(255,255,255,0.6)] leading-[1.65] max-w-[54ch] relative z-10">
                  {t("IRCC enacted a full program pause effective January 1, 2026. New applications are completely closed — only 2025 Commitment Certificate holders remain eligible. Miss the deadline and your certificate lapses permanently.", "IRCC از ۱ ژانویه ۲۰۲۶ پذیرش درخواست‌های جدید Start-Up Visa را متوقف کرده است. در حال حاضر تنها دارندگان Commitment Certificate معتبر سال ۲۰۲۵ امکان استفاده از این فرصت را دارند.")}
                </p>

                <div className="flex flex-col gap-2.5 relative z-10">
                  {[
                    { en: "Only founders with a valid 2025 Commitment Certificate can file", fa: "فقط دارندگان Commitment Certificate معتبر سال ۲۰۲۵ می‌توانند درخواست خود را ثبت کنند." },
                    { en: "All group members must submit simultaneously — one delay collapses the entire file", fa: "تمام اعضای گروه باید پرونده‌های خود را به‌صورت هم‌زمان ارائه کنند؛ تأخیر یک عضو می‌تواند کل پرونده را با مشکل مواجه کند." },
                    { en: "IRCC is actively transitioning to a new entrepreneur pilot program in late 2026", fa: "IRCC در حال حرکت به سمت یک برنامه آزمایشی جدید برای کارآفرینان در اواخر سال ۲۰۲۶ است." },
                  ].map((rule) => (
              ...
              <div className="bg-[#FFE600] px-10 py-[52px] flex flex-col gap-5 items-start justify-center">
                <div className="text-[11px] font-bold uppercase tracking-[0.1em] text-[rgba(0,0,0,0.5)]">
                  {t("Hard Submission Deadline", "آخرین مهلت ثبت درخواست")}
                </div>
                ...
                <p className="text-[13px] text-[rgba(0,0,0,0.65)] leading-[1.6]">
                  {t("If you hold a", "اگر")} <strong className="text-black font-bold">{t("2025 Commitment Certificate", "Commitment Certificate سال ۲۰۲۵")}</strong>{t(", your PR filing must be complete and submitted before this date — no extensions are available.", " را در اختیار دارید، پرونده اقامت دائم باید حداکثر تا این تاریخ به‌طور کامل آماده و ثبت شده باشد.")}
                </p>
                <a href="#contact"
                  ...
                  {t("Talk to Nexa Now →", "با نکسا مشورت کنید ←")}
                </a>
              </div>
