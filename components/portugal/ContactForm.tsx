      ...
      <Row>
        <Reveal variant="up">
          <h2 className="text-[28px] md:text-[40px] font-bold tracking-[-0.03em] text-center mb-10 md:mb-14">
            Start Your Portugal D2 Visa Journey
          </h2>
        </Reveal>
        ...
        {sent ? (
          ...
          <Reveal variant="up" delay={100}>
            <form onSubmit={handleSubmit} className="rounded-[20px] p-8 md:p-11 flex flex-col gap-5"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  ...
                  <div className="h-11 flex items-center border border-gray-200 rounded-[10px] overflow-hidden bg-white focus-within:border-[#8F27FF] transition-colors">
                    <span className="px-3 text-[13px] font-semibold border-r border-gray-200 h-full flex items-center bg-[#F4F4F4] flex-shrink-0 whitespace-nowrap">🇵🇹 +351</span>
                ...
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  ...
                  <select className="h-11 px-3.5 rounded-[10px] border border-gray-200 bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
                    ...
                    <option>Currently in Portugal (EOI)</option>
                  </select>
                </label>
                <label className="flex flex-col gap-2 text-[13px] font-medium">
                  <span className="text-[#474747]">Business Type</span>
                  <select className="h-11 px-3.5 rounded-[10px] border border-gray-200 bg-white text-[14px] font-medium outline-none focus:border-[#8F27FF] transition-colors">
              ...
              <label className="flex flex-col gap-2 text-[13px] font-medium">
                ...
                <textarea rows={4} placeholder="Describe your business model, target market in Portugal, and what you're looking to achieve…"
